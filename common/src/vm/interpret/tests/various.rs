...
fn eval_force_list() {
    ...
    assert_eq!(
        ...
        Ok(Ops(vec![Op::Const(Const::ModulatedBits("1101100011110110011100".to_string()))])),
    );
}
...
fn eval_force_list_x() {
    ...
    assert_eq!(
        ...
        Ok(Ops(vec![
            Op::Const(Const::ModulatedBits("110110010111110110001011010110011001100110011001101111100010111110111000001101100001110000".to_string())),
        ])),
    );
}
